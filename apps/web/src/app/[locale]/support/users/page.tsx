...
export default function SupportUsersPage() {
  ...
  const t = useTranslations("support.users");
          ...
          <div className="bg-white rounded-xl border shadow-sm">
            <div className="p-4 border-b">
              <h2 className="font-semibold text-gray-900">
                {searchResults.length === 0 ? t("noResults") : t("foundResults", { count: searchResults.length })}
              </h2>
            </div>
                        ...
                        <div>
                          ...
                          <div className="flex items-center gap-4 text-sm text-gray-500">
                            ...
                            <div className="flex items-center gap-1">
                              ...
                              <span>{t("joined", { date: date(user.createdAt) })}</span>
                            </div>
                          </div>
                        </div>
                      </div>
        ...
        {!hasSearched && (
          <div className="bg-blue-50 rounded-xl border border-blue-200 p-6">
            ...
            <ul className="text-sm text-blue-700 space-y-1">
              <li>• {t("tips.searchByEmail")}</li>
              <li>• {t("tips.searchById")}</li>
              <li>• {t("tips.partialMatch")}</li>
              <li>• {t("tips.clickUser")}</li>
            </ul>
          </div>
        )}
      </main>
