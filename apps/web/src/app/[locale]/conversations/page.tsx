...
export default function ConversationsPage() {
  ...
  const getOtherParty = (conv: Conversation) => {
    if (userRole === "WORKER") {
      return {
        name: conv.employer?.companyName || t("fallbackEmployer"),
        icon: Building2,
      };
    }
    return {
      name: conv.worker?.firstName
        ...
        : t("fallbackWorker", { id: conv.worker?.publicId || "?" }),
      icon: User,
    };
  };
            ...
            {selectedConversation ? (
                  ...
                  <div>
                    ...
                    {selectedConversation.offer && (
                      <p className="text-sm text-gray-500">
                        {t("regarding", { jobTitle: selectedConversation.offer.jobTitle })}
                      </p>
                    )}
                  </div>
                </div>
              ...
              <div className="flex-1 flex items-center justify-center text-gray-500">
                <div className="text-center">
                  ...
                  <p className="text-lg font-medium">{t("selectTitle")}</p>
                  <p className="text-sm mt-1">
                    {t("selectSubtitle")}
                  </p>
                </div>
